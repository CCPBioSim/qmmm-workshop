...
sed s,RC,-0.3,g ../rc_temp.RST > rc.RST
#  1.3) run minimisation
sander -O -i ../min_init.i -p ../wt.sp20.top -o min_rc-0.3init.log -c md1ps_rc-0.3.rst -ref  md1ps_rc-0.3.rst -r min_rc-0.3init.rst
...
tleap -f ../tleap_box.in &> tleap_box.out
